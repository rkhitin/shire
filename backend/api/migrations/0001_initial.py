    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('obstacle', models.OneToOneField(
                    on_delete=django.db.models.deletion.CASCADE, to='api.Obstacle')),
            ],
        ),
        migrations.CreateModel(
            name='Habbit',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True,
                                        primary_key=True, serialize=False, verbose_name='ID')),
                ('privacy_level', models.CharField(choices=[
                 ('PR', 'Личный'), ('PB', 'Публичный')], default='PR', max_length=2)),
                ('customer', models.OneToOneField(
                    on_delete=django.db.models.deletion.CASCADE, to='api.Customer')),
            ],
        ),
